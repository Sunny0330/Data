...
CREATE TRIGGER updateReview
	AFTER INSERT OR DELETE ON review_entity
    FOR EACH ROW
...
--UPDATE checkin_entity SET morning = 3 WHERE business_id = '-8ILwSisSrTzcyy_Z0o9oA' AND date = 'Friday';
...
--SELECT * FROM yelp_business_entity WHERE business_id = '--ab39IjZR_xUf81WyTyHg'
...
-- OTHER TESTS
--INSERT INTO newcustomercheckin (business_id,date,time) VALUES ('--ab39IjZR_xUf81WyTyHg', 'Friday', 'morning');
--DELETE FROM newcustomercheckin WHERE business_id='--ab39IjZR_xUf81WyTyHg' AND date='Friday' AND time='morning'
--SELECT numcheckins FROM yelp_business_entity WHERE business_id='--ab39IjZR_xUf81WyTyHg'

--INSERT INTO review_entity (review_id,business_id,user_id,stars,date,text,useful,funny,cool) VALUES ('0000111111110101111111','--ab39IjZR_xUf81WyTyHg','T5MGS0NHBCWgofZ6Q6Btng',5,'2013-06-03','TESTING',0,0,0);
--DELETE FROM review_entity WHERE review_id='0000111111110101111111'
--SELECT review_count FROM yelp_business_entity WHERE business_id='--ab39IjZR_xUf81WyTyHg'
--SELECT reviewrating FROM yelp_business_entity WHERE business_id='--ab39IjZR_xUf81WyTyHg'